                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="addForm" class="form-horizontal">
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="codeType" name="codeType" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">KEY值</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="codeKey" name="codeKey" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">VALUE值</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="codeValue" name="codeValue" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                
									<div class="form-group"><label class="col-sm-2 control-label">描述</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="codeDescribe" name="codeDescribe" maxlength="200"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
									<div class="form-group"><label class="col-sm-2 control-label">是否启用</label>
                                    <div class="col-sm-10"><input type="checkbox" class="i-checks" id="isEnable" name="isEnable" checked>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                    	<a href="javascript:void(0);" onclick="addDataDictionary();" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> 保存</button></a>
