                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    	<div style="float:left;">
								...
								<input type="text" class="form-control" style="width:300px; float:left; " id="loginName" name="loginName" placeholder="客户手机号码"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="customerIdcard" name="customerIdcard" placeholder="身份证号码"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
			            ...
			            <!-- 表格 -->
			            <div id="tableDiv">
							<jsp:include page="/WEB-INF/jsp/page/lrhAccount/lrhAccountTable.jsp" />
						</div>
                    </div>
                    </form>
                </div>
