                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="editForm" class="form-horizontal">
                                ...
                                <input type="hidden" id="menuType" name="menuType" value="${menu.menuType}"/>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">菜单顺序</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="orderNum" name="orderNum" value="${menu.orderNum}" maxlength="5"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">授权标识</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" id="menuPers" name="menuPers" value="${menu.menuPers}" maxlength="100" placeholder="多个用逗号分隔，如：user:list,user:create"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
