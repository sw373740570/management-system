                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    	<div style="float:left;">
								...
								<input type="text" class="form-control" style="width:300px; float:left; " id="wechatNickname" name="wechatNickname" placeholder="客户微信昵称"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
								<input type="text" class="form-control" style="width:300px; float:left; " id="vbsSaleSaleAgentId" name="vbsSaleSaleAgentId" placeholder="销售工号"
	                    			onkeypress="enterPress(event)" onkeydown="enterPress()" />&nbsp;&nbsp;
			            ...
			            <!-- 表格 -->
			            <div id="tableDiv">
							<jsp:include page="/WEB-INF/jsp/page/lrhWechatAttention/lrhWechatAttentionTable.jsp" />
						</div>
                    </div>
                    </form>
                </div>
