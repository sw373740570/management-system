package com.vcredit.user.controller;


import com.alibaba.fastjson.JSON;
import com.vcredit.common.util.MD5Util;
import com.vcredit.common.util.Page;
import com.vcredit.role.entity.RoleInfo;
import com.vcredit.role.service.RoleInfoService;
...
public class ManageUserController {
	...
	public String userAdd(@ModelAttribute ManageUser user, HttpServletRequest request) {
		...
		//加密密码
		String passwordEncode = MD5Util.MD5Encode(user.getUserPassword(),"");
	...
	public String resetPwd(@PathVariable String id, HttpServletRequest request) {
		...
		entity.setUserPassword(MD5Util.MD5Encode(userPassword,""));
